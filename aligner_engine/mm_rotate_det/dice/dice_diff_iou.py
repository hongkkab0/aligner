...
from aligner_engine.mm_rotate_det.dice.sort_vertices import diff_iou_rotated_sort_vertices_forward_cpu
...
class SortVertices(Function):
    ...
    def forward(ctx, vertices, mask, num_valid):
        idx = diff_iou_rotated_sort_vertices_forward_cpu(
...
def diff_iou_rotated_2d_cpu(box1: Tensor, box2: Tensor) -> Tensor:
