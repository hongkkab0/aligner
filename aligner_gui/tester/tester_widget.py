...
class TesterWidget(QWidget, Ui_tester_widget):
    ...
    def __init__(self, main_window, session, is_new: bool):
        ...
        self._th_test.qt_signal_stop_testing.connect(self._stop_testing)
        self._th_test.qt_signal_update_iter.connect(self._update_iter_th_test)
        self._th_test.qt_signal_update_test_result_summary.connect(self._update_test_result_summary)
    ...
    def _append_files(self, paths):
        ...
        self._file_list = merged

    def _update_iter_th_test(self, iter_idx: int, iter_len: int):
        self.progress_iter.setStyleSheet(TesterWidget.COLOR_INFERENCE)
    ...
    def _clicked_btn_test(self):
        if self.btn_test.isChecked():
            ...
            self._stop_testing("manual stop")
    ...
    def _start_test(self):
        try:
            ...
            self._stop_testing(const.ERROR)
    ...
    def close(self):
        self._stop_testing("window close")
        self._preview_renderer.clear()
        return super().close()
    ...
    def _update_test_result_summary(self):
        self._worker_test_result_summary = self._worker.get_test_result_summary()
